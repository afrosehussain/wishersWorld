...
<head>
 ...
 <meta property="og:type" content="Afrose Happy Eid" />
    <meta property="og:title" content="Wishing You Happy Eid" />
    <meta property="og:url" content="http://open-fast.com/dad/">
    <meta property="og:description" content="Create Eid wish" >
    <meta property="og:site_name" content="Eid Mubarak!" />
    <meta property="og:image" content="og.png"> 
<title>Afrose wishing you Happy Eid</title>
...
<h1  style="font-family:SF Espresso Shack;">Who are you</h1>
        <h3 class="fromMessage" id="fromMessage"></h3>
          <img src="eidul10.png" width="60%" height="10%"style="animation: pulse 1.5s infinite"><br><br>
<img src="adha3.png" width="70%" height="25%"style="animation: tada 4s infinite"><br><br>
<img src="mubarak.png" width="80%" height="8%"style="animation: pulse 1.5s infinite">         
<div class="wishMessage">
<p style="color:red">May you be guided by</p>
<p style="color:black">Your faith in Allah</p>
<p style="color:green">Shine in his divine blessing!</p>
<p style="color:blue">Sending you warm wish</p>
<p style="color:purple"><img src="namaste1.png" width="20px"><b>Happy Eid-al-Adha</b><img src="namaste1.png" width="20px"></p>
😍<span id="show-name" style="color: darkblue;">Afrose</span>😍
...
<div id="formBox" >
<input type="text" name="n" id="nameTextBox"  placeholder="👉 Enter your name here..." required><br>

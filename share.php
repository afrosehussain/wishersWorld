...
<head>
 ...
 <meta property="og:type" content="Happy 72nd Independence Day" />
    <meta property="og:title" content=" Wishing You Happy Independence Day" />
    <meta property="og:url" content="http://wishersworld.ga/">
    <meta property="og:description" content="Create Independence Day wish" >
    <meta property="og:site_name" content=" Happy Independence Day to you and Your Family" />
...
<img src="flag.gif" height="20px" width="20px"/><br><br>
<img src="gandhi.png" height="20px" width="20px"/><br><br>
<img src="bs.jpg" height="20px" width="20px"/><br><br>
<img src="nehru.jpg" height="20px" width="20px"/><br><br>
<img src="bose.jpg" height="20px" width="20px"/><br><br>
<img src="csa.jpg" height="20px" width="20px"/><br><br>
<img src="flag.gif" height="20px" width="20px"/><br><br>
<img src="gandhi.png" height="20px" width="20px"/><br><br>
<img src="bs.jpg" height="20px" width="20px"/><br><br>
<img src="nehru.jpg" height="20px" width="20px"/><br><br>
...
<img src="6.png" height="20px" width="20px"/><br><br>
<img src="e1.png" height="20px" width="20px"/><br><br>
<img src="e2.png" height="20px" width="20px"/><br><br>
<img src="e3.gif" height="20px" width="20px"/><br><br>
<img src="e4.gif" height="20px" width="20px"/><br><br>
...
<ins class="adsbygoogle"
     ...
     data-ad-client="ca-pub-1251254486621556"
     data-ad-slot="2462463036"></ins>
<script>
(adsbygoogle = window.adsbygoogle || []).push({});
</script>
</center>
<h1 class="username" id="#show-name {
  font-size: 25px;
  display: inline-block;
  margin-bottom: 5px;
...
@keyframes glow {
  ...
  75% {
    text-shadow: 0 0 30px cyan; } }" style="font-family:SF Espresso Shack;"></h1>
        <h3 class="fromMessage" id="fromMessage"></h3>
         <img src="eidul5.png" width="60%" height="10%"style="animation: pulse 2.5s infinite"><br><br>
<img src="adha1.png" width="70%" height="25%"style="animation: tada 4s infinite"><br><br> 
<div class="wishMessage">
<p style="color:red">May Allah bring you joy,</p>
<p style="color:black">happiness, peace and prosperity</p>
<p style="color:green">on this blessed occasion.</p>
<p style="color:blue">Wishing you and your family</p>
<p style="color:blue">on this happy occasion of Eid</p>
<p style="color:purple"><img src="namaste1.png" width="20px"><b>Eid Mubarak!</b><img src="namaste1.png" width="20px"></p>
<h1 class="username" id="show-name"></h1>
</div>
<center>
<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<!-- look 300x250 -->
<ins class="adsbygoogle"
     ...
     data-ad-client="ca-pub-1251254486621556"
     data-ad-slot="4705838219"></ins>
<script>
(adsbygoogle = window.adsbygoogle || []).push({});
</script>
</center>
<a class="footerbtn" href="whatsapp://send?text=I'm ** %0A Open this once%0A 👇🏻👇  %0A open-fast.com/eid/?n= %0A">👉 Click here to share on WhatsApp <img width="25px" height="25px" src="wp.png"/></a></div>
